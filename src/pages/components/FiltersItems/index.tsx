...
const CharacterFilters: React.FC<CharacterFiltersProps> = ({
  ...
  return (
    <S.Container>
      ...
      <S.StyledSelect name="gender" placeholder="Sexo" onChange={handleFilterChange}>
      ...
      <S.StyledSelect name="species" onChange={handleFilterChange}>
      ...
      <S.StyledSelect name="status" onChange={handleFilterChange}>
